...
# Must run before the rag.* imports below: chat.py, embed.py and store.py all
# read os.getenv at module level, so anything loaded after them is ignored.
# That is why these imports are not grouped with the rest.
# override=False so a variable already exported in the shell still wins.
load_dotenv(Path(__file__).resolve().parent / ".env", override=False)

from rag.chat import answer_with_rag  # noqa: E402
from rag.embed import embed_query, embed_texts, model_info  # noqa: E402
