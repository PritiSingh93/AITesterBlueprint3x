...
test_case_task = Task(
    description=(
        "Analyze the following feature and create test cases for it: "
        "app.vwo.com Login page with username, password, submit button, "
        "and 'remember me' functionality."
    ),
    expected_output="A numbered list of 5-10 test cases with brief descriptions.",
    agent=qa_agent
)
